...
<body class="admin-subpage admin-sessions-page">
    <?php
        ...
        <div class="dash-body">
            <main class="admin-page-shell">
                <?php
                    ...
                    $today = date('Y-m-d');
                    $sessionTotalResult = $database->query("select * from schedule;");
                    $sessionTotal = $sessionTotalResult ? $sessionTotalResult->num_rows : 0;
                ?>
                <header class="admin-page-header admin-subpage-header">
                    <a href="index.php" class="admin-back-button">Back</a>
                    <div class="admin-title-block">
                        <span class="admin-eyebrow">Session Planner</span>
                        <h1>Sessions</h1>
                        <p>Create, filter, review, and remove doctor availability sessions.</p>
                    </div>
                    <a href="?action=add-session&id=none&error=0" class="admin-btn admin-header-action">Add a Session</a>
                ...
                <section class="admin-panel admin-list-panel">
                    <div class="admin-panel-header admin-panel-header-stack">
                        <div>
                            <span class="admin-panel-kicker">Session Records</span>
                            <h2>All Sessions</h2>
                            <p><?php echo (int)$sessionTotal; ?> sessions are currently stored.</p>
                        </div>
            ...
            <table class="admin-shell-table" border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;width: 100%;" >
                        ...
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">All Sessions (<?php echo $sessionTotal; ?>)</p>
                    </td>
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <br>
                                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">No matching sessions found.</p>
    ...
    if($_GET){
        ...
        if($action=='invalid-input'){
            ...
            <div id="popup1" class="overlay">
                <div class="popup">
                    <center>
                        <h2>Invalid Session Details</h2>
                        <a class="close" href="schedule.php">&times;</a>
                        <div class="content">
                            Please complete the session form with a valid title, approved doctor, date, time, and capacity.
                        </div>
                        <div style="display:flex;justify-content:center;">
                            <a href="schedule.php?action=add-session&id=none&error=0" class="non-style-link"><button class="btn-primary btn" style="display:flex;justify-content:center;align-items:center;margin:10px;padding:10px;">Back to Form</button></a>
                        </div>
                    </center>
                </div>
            </div>';
        }elseif($action=='invalid-datetime'){
            echo '
            <div id="popup1" class="overlay">
                <div class="popup">
                    <center>
                        <h2>Past Time Not Allowed</h2>
                        <a class="close" href="schedule.php">&times;</a>
                        <div class="content">
                            Session date and time cannot be set in the past.
                        </div>
                        <div style="display:flex;justify-content:center;">
                            <a href="schedule.php?action=add-session&id=none&error=0" class="non-style-link"><button class="btn-primary btn" style="display:flex;justify-content:center;align-items:center;margin:10px;padding:10px;">Back to Form</button></a>
                        </div>
        ...
        }elseif($action=='doctor-not-approved'){
            echo '
            <div id="popup1" class="overlay">
                <div class="popup">
                    <center>
                        <h2>Doctor Not Approved</h2>
                        <a class="close" href="schedule.php">&times;</a>
                        <div class="content">
                            Only approved doctors can be assigned sessions.
                        </div>
                        <div style="display:flex;justify-content:center;">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    ...
                                    <option value="" disabled selected hidden>Choose Doctor Name from the list</option><br/>';
                                        ...
                                        $list11 = $database->query("select * from doctor where verification_status='approved' order by docname asc;");
                                ...
                                <center>
                                 ...
                                 <tbody>';
                                         ...
                                         if($result->num_rows==0){
                                             ...
                                             <br>
                                             <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">No matching appointments found for this session.</p>
